...
@media (prefers-reduced-motion: reduce) {
  body::after { animation: none; opacity: 0.5; }
    ...
    #intro .intro-title {
      ...
      text-transform: uppercase;
      color: #fff;
      text-shadow: 0 0 18px rgba(102, 191, 255, 0.6);
      animation: introIn 1.1s ease-out 0.18s both;
    }
    @keyframes introIn {
    ...
    @media (prefers-reduced-motion: reduce) {
      ...
      #intro img, #intro .intro-title { animation: none; }
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      try {
        ...
        // Bouton "retour en haut" : apparaît après défilement, scroll doux au clic
