...
<body>
  ...
  <div class="marquee" aria-hidden="true">
    <div class="marquee-track">
      <span>◆ <b>Cryptonauts Leaderboards</b></span><span>Live on crypto.com NFT</span><span>◆ Real-time holder rankings</span><span>11 Collections</span><span>◆ <b>Cryptonauts Leaderboards</b></span><span>Live on crypto.com NFT</span><span>◆ Real-time holder rankings</span><span>11 Collections</span>
    </div>
  </div>
  ...
  <nav class="navbar" id="navbar">
    ...
    <div class="nav-links">
      ...
      <a href="https://x.com/Cronos_WTF" target="_blank" rel="noopener">X</a>
    </div>
  ...
  <header id="home" class="hero">
    ...
    <div class="hero-inner">
      <div class="hero-copy">
        <span class="eyebrow">◆ Crypto.com NFT · Real-time</span>
        <h1 class="hero-title">Crypto<span>nauts</span></h1>
        <p class="hero-sub">The official live leaderboards of the Cryptonauts universe. Explore every collection and discover the top holders across the galaxy — straight from the crypto.com NFT chain.</p>
    ...
    <a href="#collections" class="scroll-cue" aria-label="Scroll to collections"><span>Scroll</span><span class="chev">⌄</span></a>
  </header>

  <main>
    <section class="section reveal" id="collections">
      <div class="section-head">
        <span class="eyebrow">◆ The Galaxy</span>
        <h2 class="section-title">Collections</h2>
        <p class="section-sub">Eleven collections orbiting the Cryptonauts universe. Tap any card to reveal its full holder ranking.</p>
      </div>
