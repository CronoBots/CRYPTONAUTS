...
@media (prefers-reduced-motion: reduce) {
  body::after { animation: none; opacity: 0.5; }
    ...
    .iv-article { max-width: 768px; margin: 0 auto; text-align: left; counter-reset: ivq; }
    ...
    /* Lede */
    .iv-article p.iv-lede { color: #eaf2ff; font-size: 1.18rem; line-height: 1.62; margin: 0 0 8px; padding-bottom: 24px; border-bottom: 1px solid var(--hairline); }
    /* Q&A numérotées */
    ...
    /* Source */
    .iv-article p.iv-source { margin: 38px 0 0; padding-top: 20px; border-top: 1px solid var(--hairline); font-size: 0.84rem; color: var(--muted); line-height: 1.6; }
    .iv-source a { color: var(--primary-color); }
    /* Bouton CTA "lire l'original" */
    .iv-cta { display: inline-flex; align-items: center; gap: 12px; margin: 36px 0 0; padding: 13px 22px; border-radius: 999px; font-family: var(--font-body); font-size: 0.84rem; letter-spacing: 0.06em; text-transform: uppercase; color: #eaf2ff; border: 1px solid rgba(102,191,255,0.4); background: linear-gradient(120deg, rgba(102,191,255,0.12), rgba(232,192,105,0.08)); transition: transform 0.25s ease, border-color 0.25s ease, box-shadow 0.25s ease; }
